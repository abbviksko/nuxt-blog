<template>
  <nav class=" w-full p-6  greyBackground bre" style="height: 12vh;">

    <div class="flex left-80 object-fit: cover; object-right-top justify-between">

          <div>
   <img src="../static/images/crosslogo3.jpg" class="object-left" style="height: 15vh;">
    </div>
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-sm font-sans text-xl justify-end ">
          <li><a href="/" class="NavBar">Home</a></li>
          <li><a href="/About" class="NavBar">About</a></li>
          <li><a href="/blogpages" class="NavBar">My blog</a></li>
          </ul>
